...
## 작업 2. Copilot Studio에 로그인하기
   ...
   3.  **Sign in** 제공된 비밀번호를 입력하고 로그인 클릭</br>
   ...
   5. Microsoft Copilot Studio에 처음 액세스하면 국가/지역을 선택하라는 메시지가 표시된다면, 값을 선택하거나 기본 옵션을 그대로 두고 시작하기를 클릭할 수 있습니다.

       <img src="./images/image9-3.png" >

   6. Copilt Studio에 로그인한 후, 실습을 위한 **Environment**로 변경을 해 주어야합니다.
